...
public class Cube {
    ...
    public void generateTriangles() {
        ...
        faces.add(new Triangle(vertices.get(2), vertices.get(3), vertices.get(0), c));

        // face 2
        faces.add(new Triangle(vertices.get(3), vertices.get(0), vertices.get(4), c));
        faces.add(new Triangle(vertices.get(3), vertices.get(4), vertices.get(5), c));

        // face 3
        faces.add(new Triangle(vertices.get(5), vertices.get(6), vertices.get(7), c));
        faces.add(new Triangle(vertices.get(5), vertices.get(4), vertices.get(7), c));

        // face 4
        faces.add(new Triangle(vertices.get(0), vertices.get(4), vertices.get(7), c));
        faces.add(new Triangle(vertices.get(0), vertices.get(1), vertices.get(7), c));

        // face 5
        faces.add(new Triangle(vertices.get(1), vertices.get(2), vertices.get(6), c));
        faces.add(new Triangle(vertices.get(1), vertices.get(7), vertices.get(6), c));

        // face 6
        faces.add(new Triangle(vertices.get(2), vertices.get(3), vertices.get(5), c));
        faces.add(new Triangle(vertices.get(2), vertices.get(6), vertices.get(5), c));
    }
    ...
    public ArrayList<Vector3f> generateVertices() {
        n1.scale(radius);
        n2.scale(radius);
        Vector3f n3 = Vector3f.cross(n1, n2).scale(radius);

        Vector3f c1 = (new Vector3f(n1).add(n2)).add(n3);
        Vector3f c2 = (new Vector3f(n1).add(n2)).subtract(n3);

        Square s1 = new Square(new Vector3f(center).add(n3), c1, n3, color);
        Square s2 = new Square(new Vector3f(center).subtract(n3), c2, n3.invert(), color);
